...
// console.log(emailName.slice(emailName.length-3)+'...@'+email.split('@')[1]);
...
let abc = dizi.reduce((total, value) => (total += value));
console.log(abc / dizi.length);
...
const outsayi = Number(sayi.toString().split("").sort().reverse().join(""));
